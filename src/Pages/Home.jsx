...
const WORDS = ["Software Engineer", "Backend Developer", "Full-Stack Engineer"];
const TECH_STACK = ["Python","Django/DRF","PostgreSQL","Redis","Docker","GCP","Java","Spring Boot","JavaScript","React"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/abhinavReja" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/abhinavreja/" },
  { icon: Instagram, link: "https://www.instagram.com/a.bhimanyu_17/" },
  { icon: Mail, link: "mailto:abhinavreja2000@gmail.com"}
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden pt-20 md:pt-24 scroll-mt-24" id="Home">
      <div
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  I build reliable, user-friendly products—polished UIs on top of scalable APIs and cloud infrastructure.
                </p>
